            ...
            <motion.div 
                ...
                <div className="z-10 mt-32 md:basis-3/5">
                    ...
                    <motion.div 
                        ...
                        <p className="mt-8 text-sm ">Unrivaled Gym. Unparralled Training Fitness Classes. World class Studios to get the Body shape that you Dream of... Get Your Dream Body Now.</p>
                    </motion.div>
                ...
                <div className='h-[150px] w-full bg-primary-100 py-10'>
                    <div className="mx-auto w-5/6">
                        <div className="flex w-3/5 items-center justify-between gap-8">
                            ...
                            <img src={SponsorFortune} alt="fortune-500-sponsor" />
                        </div>
                    </div>
                </div>
            )}
