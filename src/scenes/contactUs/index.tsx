      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage)}>
        ...
        {/* HEADER */}
          ...
          >
            ...
            <p className="my-5">
              Join us today and discover the transformative power of our exercise classes. Whether you're a beginner or a seasoned fitness enthusiast, we have something to offer everyone.
            </p>
          </motion.div>
